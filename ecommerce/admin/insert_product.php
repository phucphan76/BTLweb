...
<div class="container mt-3">
    ...
    <form action="" method="post" enctype="multipart/form-data">
        ...
        <div class="form-outline mb-4 w-50 m-auto">
            ...
            <textarea name="description" id="description" class="form-control" placeholder="Enter product description" autocomplete="off" required="required" rows="5"></textarea>
            <!-- <input type="textarea" name="description" id="description" class="form-control" placeholder="Enter product description" autocomplete="off" required="required"> -->
        </div>
        <!-- keywords -->
        <div class="form-outline mb-4 w-50 m-auto">
        ...
        <!-- button -->
        <div class="form-outline mb-4 w-50 m-auto">
            <input type="submit" name="insert_product" class="btn btn-info mb-3 px-3" value="Insert Products" id="">
        </div>
    </form>
</div>
